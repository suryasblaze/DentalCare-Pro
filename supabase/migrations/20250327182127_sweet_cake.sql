...
DROP POLICY IF EXISTS "Allow authenticated users to view settings" ON clinic_settings;
DROP POLICY IF EXISTS "Allow authenticated users to update settings" ON clinic_settings;
